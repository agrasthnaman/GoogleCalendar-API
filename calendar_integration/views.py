...
class GoogleCalendarRedirectView(APIView):
    def get(self, request):
        ...
        # Fetching the OAuth 2.0 tokens using the authorization server.
        ...
        try:
            ...
            # Upcoming Events
            upcoming_events_result = service.events().list(calendarId='primary', timeMin=now, singleEvents=True,
